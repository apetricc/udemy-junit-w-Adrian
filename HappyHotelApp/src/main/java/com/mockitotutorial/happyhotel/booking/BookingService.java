...
//has dependency on roomService class --> roomService.getAvailableRooms(); so we need to mock it
	...
	//has dependency on roomService, mailSender, paymentService, bookDAO classes --> roomService.getAvailableRooms() etc...; so we need to mock them
	...
	//has dependency on roomService, & bookingDAO classes --> roomService.getAvailableRooms() etc...; so we need to mock them
