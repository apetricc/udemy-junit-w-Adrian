...
class Test11Annotations {
	//instead of using a setup() method, we can use Mockito annotations which is the preferred method of working with mockito actually:
...
//	}
	...
	//the given, when, then pattern comes from the behavior driven development principle, or "BDD" for short
	//although it doesn't really match the methods in Mockito, but there are aliases  we can use to make it match better
	...
	void should_PayCorrectPrice_When_InputOK() {
		...
		//then
		//previously we knew that the price to pay would be '400.0', this time instead of using the value that we expect, we will use a captor to capture/catch the value
	...
	}//should_PayCorrectPrice_When_InputOK()
	...
	}//should_PayCorrectPrices_When_MultipleCalls()
	
}//Test11Annotations class
